...
function friendlyLoginError(msg) {
  ...
  if (msg.toLowerCase().includes('credential') || msg.toLowerCase().includes('invalid'))
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(friendlyLoginError(err.response?.data?.error));
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-primary-light flex flex-col px-6 py-12">
      ...
      <h1 className="font-syne font-bold text-3xl text-gray-900 mb-2">Welcome back</h1>
      <p className="text-base text-gray-500 mb-8">Track your nutrition, reach your goals</p>
